...
if __name__ == '__main__':
    ...
    parser.add_argument('--fix_length', type=int, default=200)
    ...
    TEXT.build_vocab(train, vectors=GloVe(name='6B', dim=dim_embdeding), max_size=args.max_vocab_size, min_freq=10)
...
#    batch = next(iter(train_iter))    
    ...
    if args.model == 'Naive':    
        ...
        model = IMDBCnn(vocab_size=TEXT.vocab.vectors.shape[0], dim_embdeding=TEXT.vocab.vectors.shape[1], num_classes=num_classes)
    elif args.model == 'LSTM':
        model = IMDBRnn(vocab_size = TEXT.vocab.vectors.shape[0], dim_embdeding = TEXT.vocab.vectors.shape[1], num_classes=num_classes)
